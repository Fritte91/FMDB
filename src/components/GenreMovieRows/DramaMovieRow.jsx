...
const DramaMovieRow = () => {
  ...
  useEffect(() => {
    const fetchDramaMovies = async () => {
      const response = await fetch('https://yts.mx/api/v2/list_movies.json?genre=drama&minimum_rating=5&limit=50&with_rt_ratings=true&sort_by=rating&order_by=desc');
